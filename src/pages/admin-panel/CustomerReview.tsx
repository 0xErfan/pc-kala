...
const CustomerReview = () => {
    return (
        <div className='p-6 flex items-center gap-4 bg-white rounded-xl shadow-sm w-[458px] relative overflow-visible'>
            ...
            <div className='overflow-hidden size-[233px] rounded-full bg-panel-caption shadow-sm z-20 ch:size-full absolute -left-[25%]'><Image className=' object-cover p-2' src={'https://pc-kala.storage.iran.liara.space/Acer%20Nitro%205%203060%20Gaming%20Laptop%2C%2015.6%20FHD%20IPS%20144Hz%2C%20GeForce%20RTX%203060.webp'} width={300} height={300} quality={100} alt='photo' /></div>
        </div>
    )
}
