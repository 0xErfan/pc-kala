        ...
        <Layout>
            <div>
                ...
                <table className='w-full text-center overflow-x-auto rounded-md'>
                    ...
                    <thead>
                        <tr className='font-peyda md:text-[20px] text-[16px] text-center w-full ch:bg-white ch:py-2 ch:text-panel-darkTitle'>
                            <td>شماره</td>
                            <td>شناسه</td>
                            <td>ارزش(تومان)</td>
                    ...
                    <tbody className='overflow-auto'>
                        <tr className='ch:border-2 even:bg-panel-lightRed ch:border-white ch:py-2'>
                            <td>1</td>
                            <td>oneMilOffForSummer</td>
                            <td>12000000</td>
                            <td>2000</td>
                            <td>651</td>
                            <td className='flex-center text-panel-darkRed cursor-pointer ch:size- md:ch:size-6'><MdDeleteOutline /></td>
                        </tr>
                        <tr className='ch:border-2 even:bg-panel-lightRed ch:border-white ch:py-2'>
                            <td>1</td>
                            <td>oneMilOffForSummer</td>
