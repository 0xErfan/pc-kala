...
export const Input = ({ required = true, title, placeHolder, type = "text", name, fn }: inputProps) => {
    ...
    const inputValueChecker = (e: React.FocusEvent<HTMLInputElement, Element>) => {
    ...
    return (
        <div className="flex flex-col gap-2 text-[12px] text-description-text">
            ...
            <input
                className={`appearance ltr bg-primary-black outline-none border rounded-md border-white/20 p-2`}
                type={type}
