    ...
    return (
        ...
        <section className="primary-bg overflow-x-hidden font-sans">
            ...
            <div className="container flex-col lg:flex-row flex ch:flex-1 gap-8 my-12">
                ...
                <div data-aos-duration="600" data-aos="zoom-in"><img className="w-full h-full object-cover" src="/images/home/laptop.webp" alt="pc-kala" /></div>
            </div>
            ...
            <div className="container flex-col lg:flex-row flex ch:flex-1 gap-8 mt-36 mb-24">
                <div data-aos-duration="600" data-aos="zoom-in"><img className="max-h-[480px] m-auto h-full  w-[200px] " src="/images/home/case.webp" alt="pc-kala" /></div>
                <div data-aos-duration="600" data-aos="zoom-in">
            ...
            <div className="container flex-col lg:flex-row flex ch:flex-1 gap-8 lg:gap-3 mt-36 mb-24">
                ...
                <div data-aos-duration="600" data-aos="zoom-in" className=" ch:mr-auto h-[481px]"><img className="sm:max-w-[450px] size-auto m-auto object-cover" src="/images/home/ghesti.webp" alt="pc-kala" /></div>
            </div>

            <div className="container flex-col lg:flex-row flex ch:flex-1 gap-8 mt-36 mb-24">
                <div data-aos-duration="600" data-aos="zoom-in"><img className="m-auto lg:h-[600px] h-auto w-[500px]" src="/images/home/parts.webp" alt="pc-kala" /></div>
