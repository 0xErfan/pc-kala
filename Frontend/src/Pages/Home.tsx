    ...
    return (
        <section className="primary-bg overflow-x-hidden font-sans">
            ...
            <div className="container pt-[80px] flex-col-reverse lg:flex-row flex ch:flex-1 gap-8 my-12">
                <div data-aos-anchor="#example-anchor"
                    data-aos-offset="500"
                ...
                <div data-aos-anchor="#example-anchor"
                    data-aos-offset="500"
                    data-aos-duration="1000" data-aos="fade-right"><img className="w-full h-full object-cover" src="/images/home/laptop.webp" alt="pc-kala" /></div>
            </div>
            ...
            <div className="container flex-col lg:flex-row flex ch:flex-1 gap-8 mt-36 mb-24">
                <div data-aos-anchor="#example-anchor"
                    data-aos-offset="500"
                    data-aos-duration="1000" data-aos="fade-right"><img className="max-h-[480px] m-auto h-full  w-[200px] " src="/images/home/case.webp" alt="pc-kala" /></div>
                <div data-aos-anchor="#example-anchor"
                    data-aos-offset="500"
                    data-aos-duration="1000" data-aos="fade-left">
            ...
            <div className="container flex-col-reverse lg:flex-row flex ch:flex-1 gap-8 lg:gap-3 mt-36 mb-24">
                <div data-aos-anchor="#example-anchor"
                    data-aos-offset="500"
                    data-aos-duration="1000" data-aos="fade-left" className="px-[29px]">
                    <h3 className="thin-title mt-4" >انتخاب هوشمندانه</h3>
                    <h5 className="bold-title sm:text-[42px] text-[24px] lg:text-[32px]">خرید اقساطی کامپیوتر و لپ تاپ</h5>
                ...
                <div data-aos-anchor="#example-anchor"
                    data-aos-offset="500"
                    data-aos-duration="1000" data-aos="fade-right" className=" ch:mr-auto h-[481px]"><img className="sm:max-w-[450px] size-auto m-auto object-cover" src="/images/home/ghesti.webp" alt="pc-kala" /></div>
            </div>

            <div className="container flex-col lg:flex-row flex ch:flex-1 gap-8 mt-36 mb-24">
                <div data-aos-anchor="#example-anchor"
                    data-aos-offset="500"
                    data-aos-duration="1000" data-aos="fade-right"><img className="m-auto lg:h-[600px] h-auto w-[500px]" src="/images/home/parts.webp" alt="pc-kala" /></div>
                <div data-aos-anchor="#example-anchor"
                    data-aos-offset="500"
                    data-aos-duration="1000" data-aos="fade-left" className="flex flex-col justify-center">
            ...
            <section>
                <div className="pt-[150px] size-60 lg:size-auto m-auto"><img className="m-auto " src="/images/home/pckala.webp" alt="pc-kala-logo" /></div>

                <div className="flex items-center justify-center ch:shrink ch:size-auto gap-0 lg:gap-8 xl:gap-24 mt-20 lg:mt-10">
