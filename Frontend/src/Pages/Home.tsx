    ...
    return (
        <section className="primary-bg overflow-x-hidden">
            ...
            <div className="container flex-col-reverse lg:flex-row flex ch:flex-1 gap-8 lg:gap-3 mt-36 mb-24">
                ...
                <div className=" ch:mr-auto h-[481px]"><img className="sm:max-w-[450px] size-auto m-auto object-cover" src="/images/home/ghesti.webp" alt="pc-kala" /></div>
            </div>

            <div className="container flex-col lg:flex-row flex ch:flex-1 gap-8 mt-36 mb-24">
                <div><img className="m-auto lg:h-[600px] h-auto w-[500px]" src="/images/home/parts.webp" alt="pc-kala" /></div>
