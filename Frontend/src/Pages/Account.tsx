...
const Account = () => {
    ...
    return (
        ...
        <section className="bg-primary-black">
            ...
            <div className="flex container gap-5 ch:rounded-md ch:border ch:border-dark-gold ch:bg-secondary-black text-white text-[12px]">

                <div className="flex-1 ch:px-3 ch:py-5 overflow-hidden ch:transition-colors">
                    ...
                    <div className="flex items-center relative gap-2 border-b border-gray-600/15 pb-3 cursor-pointer hover:bg-black/15">
                        <IoBagHandleOutline className="size-5" />
                        <p>سفارش ها</p>
                    </div>

                    <div className="flex items-center gap-2 border-b border-gray-600/15 pb-3 cursor-pointer hover:bg-black/15">
                    ...
                    <div className="flex items-center justify-between border-b border-gray-600/15 pb-3 cursor-pointer hover:bg-black/15">
